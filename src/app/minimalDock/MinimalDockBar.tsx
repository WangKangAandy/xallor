...
const CAPSULE_CLASS =
  "pointer-events-auto flex items-center justify-center gap-2.5 rounded-2xl border border-white/30 bg-white/20 py-3 pl-4 pr-4 shadow-[0_16px_48px_-16px_rgba(15,23,42,0.55)] backdrop-blur-xl dark:border-white/12 dark:bg-slate-900/50";
